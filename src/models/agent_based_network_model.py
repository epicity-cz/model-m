...
class SimulationDrivenModel(BaseEngine):
    ...
    def setup_series_and_time_keeping(self):
        ...
        # keep track of mena number of infectious contacts
        self.mean_inf_contacts = TimeSeries(
            self.expected_num_days, dtype=float)
        self.mean_inf_contacts[0] = 0
        self.nodes_inf_contacts = np.zeros(self.num_nodes, dtype=int)
    ...
    def run_iteration(self):
        ...
        self.nodes_inf_contacts.fill(0)
        ...
        self.mean_inf_contacts[self.t] = self.nodes_inf_contacts.mean()
    ...
    def die_or_not_to_die(self, target_nodes):
        ...
        age = self.graph.nodes_age[target_nodes]
    ...
    def get_time_to_die(self, target_nodes):
        ...
        lower = random_u < self.dtime_coef  # todo, make param
    ...
    def to_df(self):
        ...
        df = super().to_df()
        df["mean_inf_contacts"] = self.mean_inf_contacts[:self.t+1]
        if self.start_day != 1:
