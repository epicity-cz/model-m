...
def load_scenario_dict(filename: str, sep=',', return_data='list'):
    """
    Loading scenario, typically for layer weights changes.
    From CSV file it creates a dictionary of {key: list}, where key is a number of day and list contains weights of layers. 
    """
