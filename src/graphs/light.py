...
class LightGraph:
    ...
    def read_csv(self,
        ...
        #        logging.info("DBG graphs warning: multiplying intensities by 5")
    ...
    def set_layer_weights(self, weights):
        ...
        # for i, w in enumerate(weights): # TODO: proc to delam takhle blbe? 
        #     #    print("DBG ", i, " --> ", w, end=" ")
    ...
    def copy(self):
        ...
        """
        heavy_fields = ['e_valid', 'layer_weights', 'e_active', 'e_layer_weight']
        new = copy(self)
