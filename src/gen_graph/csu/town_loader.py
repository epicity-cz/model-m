...
def load(zuj, cache_dir):
    reader112 = reader.Reader(zuj, 112, cache_dir)
    reader113 = reader.Reader(zuj, 113, cache_dir)
    reader114 = reader.Reader(zuj, 114, cache_dir)
    reader115 = reader.Reader(zuj, 115, cache_dir)
    reader116 = reader.Reader(zuj, 116, cache_dir)
    reader122 = reader.Reader(zuj, 122, cache_dir)
