...
def from_graph(grph: MGraph, parameters: Parameters) -> List[PlosMatrix]:
    ...
    for (p1, p2, link) in grph.links():
        ...
        pt1.add_contact(p1.age, p2.age, link.probability_real(parameters))
        pt1.add_person(p1, p1.age)

        pt2 = items[ld.second]

        pt2.add_contact(p2.age, p1.age, link.probability_real(parameters))
