...
def create_custom_model(clsname, states, state_str_dict, transitions,
    ...
    Params:
         ...
         calc_propensities    you can specify funkction calc_propensities (for seirpluslike derived engines)
         member fucntions     or your own set of member functions (for your custom engine)
