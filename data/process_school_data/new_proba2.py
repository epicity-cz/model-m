...
replace_dict["out_school"] = {
    "Jednou za den": 1,
    "Několikrát za den":  2.5,
    "Občas": 2/5,
    "Málo kdy": 0.5/5  # jednou za 14 dní
}

replace_dict["desk_sometime"] = {'lavice': 2/5}
...
replace_dict["free_time"] = {np.nan: (3/15)/5}
...
replace_dict["in_class"] = {
    'Třída 2. stupeň': 5 * 0.02,
    'Třída 1. stupeň': 4 * 0.02
}
...
df.loc[df["layer"].isin(teacher_student), "score"] = (
    hours/5) * (3/25)  # 25 pocet deti ve tride TODO
